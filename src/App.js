                    ...
                    {task && task.map((task, index) => (
                        <li key={index} className={styles.task}>
                            ...
                            <span onClick={() => DeleteTask(index)} className={styles.changeTask}>
                                <svg focusable="false" viewBox="0 0 24 24" fill='#0000008a' aria-hidden="true" data-testid="DeleteIcon"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"></path></svg>
                            </span>
                        </li>
                    ))}
                </ul>
